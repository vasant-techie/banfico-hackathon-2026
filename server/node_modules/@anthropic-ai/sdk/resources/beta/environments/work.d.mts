...
import { WorkPoller, type WorkPollerOptions as RunnerWorkPollerOptions } from "../../../lib/environments/poller.mjs";
import { EnvironmentWorker, type EnvironmentWorkerOptions as RunnerEnvironmentWorkerOptions } from "../../../lib/environments/worker.mjs";
export declare class Work extends APIResource {
    /**
     ...
     * ```
     */
    retrieve(workID: string, params: WorkRetrieveParams, options?: RequestOptions): APIPromise<BetaSelfHostedWork>;
    /**
     * Note: these endpoints are called automatically by the pre-built environment
     * worker provided in the SDKs and CLI, for orchestrating sessions with self-hosted
     * sandbox environments. They are included here as a reference; you do not need to
     ...
     * ```
     */
    list(environmentID: string, params?: WorkListParams | null | undefined, options?: RequestOptions): PagePromise<BetaSelfHostedWorksPageCursor, BetaSelfHostedWork>;
    /**
     * Note: these endpoints are called automatically by the pre-built environment
     * worker provided in the SDKs and CLI, for orchestrating sessions with self-hosted
     * sandbox environments. They are included here as a reference; you do not need to
     ...
     * ```
     */
    heartbeat(workID: string, params: WorkHeartbeatParams, options?: RequestOptions): APIPromise<BetaSelfHostedWorkHeartbeatResponse>;
    /**
     * Note: these endpoints are called automatically by the pre-built environment
     * worker provided in the SDKs and CLI, for orchestrating sessions with self-hosted
     * sandbox environments. They are included here as a reference; you do not need to
     ...
     * ```
     */
    poll(environmentID: string, params?: WorkPollParams | null | undefined, options?: RequestOptions): APIPromise<BetaSelfHostedWork | null>;
    /**
     ...
     * ```
     */
    stats(environmentID: string, params?: WorkStatsParams | null | undefined, options?: RequestOptions): APIPromise<BetaSelfHostedWorkQueueStats>;
    /**
     * Note: these endpoints are called automatically by the pre-built environment
     * worker provided in the SDKs and CLI, for orchestrating sessions with self-hosted
     * sandbox environments. They are included here as a reference; you do not need to
